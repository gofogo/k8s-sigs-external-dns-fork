...
| changes_total                           | Counter     | controller       | Number of DNS record changes applied, partitioned by action and record type.                                                                       |
| consecutive_soft_errors                 | Gauge       | controller       | Number of consecutive soft errors in reconciliation loop.                                                                                          |
| filtered_endpoints_total                | Counter     | controller       | Number of endpoints removed before planning, partitioned by filter reason.                                                                         |
...
| reconcile_duration_seconds              | Histogram   | controller       | Duration of reconciliation loops in seconds.                                                                                                       |
...
| operation_duration_seconds              | Histogram   | provider         | Duration of DNS provider operations in seconds, partitioned by operation type.                                                                     |
| endpoints_total                         | Gauge       | registry         | Number of Endpoints in the registry                                                                                                                |
| errors_total                            | Counter     | registry         | Number of Registry errors partitioned by operation.                                                                                                |
...
| endpoints_by_type                       | Gauge       | source           | Number of endpoints per source type, partitioned by source type and record type.                                                                   |
