...
| rate_limiter_duration_seconds           | Histogram   | rest_client      | verb, url                                   | Client-side rate limiter latency in seconds, partitioned by verb and URL path.                                                                     |
| request_size_bytes                      | Histogram   | rest_client      | verb, host                                  | Request size in bytes, partitioned by verb and host.                                                                                               |
| response_size_bytes                     | Histogram   | rest_client      | verb, host                                  | Response size in bytes, partitioned by verb and host.                                                                                              |
| retry_requests_total                    | Counter     | rest_client      | code, method, host                          | Number of retried requests to the Kubernetes API, partitioned by status code, method, and host.                                                    |
