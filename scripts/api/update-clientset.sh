...
# https://github.com/kubernetes-sigs/gateway-api/blob/main/hack/update-clientset.sh
...
# go install k8s.io/code-generator/cmd/register-gen@v0.32.3
go run register-gen --output-file zz_generated.register.go "apis/dnsendpoint/v1alpha1"
go run k8s.io/code-generator/cmd/register-gen --output-file zz_generated.register.go
